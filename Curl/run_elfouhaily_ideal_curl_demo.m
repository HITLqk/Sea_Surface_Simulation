...
assert(surfaceData.metrics.maxDownwardDisplacement > ...
    0.25*surfaceData.metrics.maxForwardDisplacement, ...
    'The crest advances but does not develop a mature downward curl.');

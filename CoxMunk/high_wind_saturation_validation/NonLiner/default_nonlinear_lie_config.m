...
% Optional high-wind spectral-tail dissipation. The closure is disabled in
% the original model and is enabled only by the separate hurricane test.
cfg.sea.highWindSaturation.enabled = false;
cfg.sea.highWindSaturation.windSpeeds = [];
cfg.sea.highWindSaturation.mu = [];
cfg.sea.highWindSaturation.gain = [];
cfg.sea.highWindSaturation.wavenumberExponent = 2.0;
